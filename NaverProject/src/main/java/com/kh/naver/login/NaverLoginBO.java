...
public class NaverLoginBO {
    ...
    public final static String CLIENT_ID = ""; // 클라이언트 아이디
    public final static String CLIENT_SECRET = ""; // 클라이언트 시크릿
    public final static String REDIRECT_URI = "http://localhost:8007/naver/callbackNaver.do";
